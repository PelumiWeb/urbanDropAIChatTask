...
export const HatchFill = `linear-gradient(135deg, ${HATCH_STOPS})`;

export function Hatch({ style, label }: { style?: StyleProp<ViewStyle>; label?: string }) {
  return (
...
const styles = StyleSheet.create({
  hatch: {
    ...
    experimental_backgroundImage: HatchFill,
    overflow: 'hidden',
    alignItems: 'center',
